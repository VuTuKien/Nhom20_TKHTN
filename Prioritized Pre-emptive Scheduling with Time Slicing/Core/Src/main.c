...
/* USER CODE BEGIN Header_RunTask1 */
/**
...
/* USER CODE BEGIN Header_RunTask2 */
/**
...
//		  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_6, GPIO_PIN_RESET);
  ...
  /* USER CODE END RunTask2 */
}

/* USER CODE BEGIN Header_RunTask3 */
/**
...
void RunTask3(void const * argument)
{
  ...
  /* USER CODE END RunTask3 */
}

/* USER CODE BEGIN Header_RunTask4 */
/**
* @brief Function implementing the Task3 thread.
* @param argument: Not used
* @retval None
...
void RunTask4(void const * argument)
{
  ...
  /* USER CODE END RunTask4 */
}

/* USER CODE BEGIN Header_RunTask5 */
/**
